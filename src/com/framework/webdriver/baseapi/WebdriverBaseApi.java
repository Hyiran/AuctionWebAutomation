...
public class WebdriverBaseApi {
	...
	public Set<String> getWindowHandles() {
		...
		logger.debug("window handles are: " + handle.toString());
		return handle;
	}
	...
	/**
	 * 获取elementLocator页面元素定位器对应的页面元素个数
	 * 
	 * @param elementLocator
	 *            Selenium页面元素定位器
	 * @param timeout
	 *            超时时间，单位：秒
	 * @return elementLocator页面元素定位器对应的页面元素个数
	 */
	public int getNumberOfElements(By elementLocator, long timeout) {
		boolean isSucceed = false;
		int elementCount = 0;
		long timeBegins = System.currentTimeMillis();
		do {
			try {
				...
				isSucceed = true;
				logger.debug("find element [ " + elementLocator.toString()
	 ...
	 * @return elementLocator页面元素定位器对应的页面元素个数
	 */
	public int getNumberOfElements(By elementLocator) {
